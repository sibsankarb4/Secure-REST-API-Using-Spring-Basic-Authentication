package com.sibsankar.springmvc;
...
import com.sibsankar.springmvc.model.User;
 
public class SpringRestClient {
 
    public static final String REST_SERVICE_URI = "http://localhost:8080/SecureRESTApiUsingSpringBasicAuthentication";
